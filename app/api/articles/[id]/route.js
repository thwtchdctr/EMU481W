...
const categoryKeywords = {
  ...
  Politics: [
    ...
    { word: "trump", weight: 4 }, { word: "biden", weight: 4 }, { word: "vance", weight: 3 },  {word: "gop", weight: 3},
...
export async function GET(req, { params }) {
  ...
  try {
    ...
    const sentimentResult = sentiment.analyze((article.content+" "+article.description+" "+article.title).toLowerCase());
    const categories = categorizeArticle(article.content, article.description, article.title);
